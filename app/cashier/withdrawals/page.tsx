...
export default function WithdrawalsPage() {
  ...
  return (
    <main className="p-4 md:p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Withdrawal Transactions</h1>
        <p className="text-gray-600 mt-1">Process member withdrawals</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-center py-8 text-gray-500">No withdrawals recorded</div>
        </CardContent>
      </Card>
    </main>
  )
